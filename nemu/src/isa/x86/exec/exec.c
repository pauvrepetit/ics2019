...
/* 0xf6, 0xf7 */
make_group(gp3,
    EMPTY, EMPTY, IDEX(nop, not), EMPTY,
    EMPTY, EMPTY, EMPTY, EMPTY)
...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x08 */	EMPTY, IDEX(or_09, or), IDEXW(or_0a, or, 1), EMPTY,
  ...
  /* 0x38 */	EMPTY, EMPTY, EMPTY, IDEX(cmp_3b, cmp),
  ...
  /* 0xe8 */	IDEXW(call_rel32, call, 4), EMPTY, EMPTY, EMPTY,
