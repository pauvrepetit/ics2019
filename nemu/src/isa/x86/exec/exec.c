...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0xa4 */	EXW(movsb, 1), EX(movs), EMPTY, EMPTY,
  ...
  /* 0xe8 */	IDEX(call_rel, call), IDEX(J, jmp), EMPTY, IDEXW(J, jmp, 1),
...
/*2 byte_opcode_table */
  ...
  /* 0x20 */	IDEX(G2E, mov_cr2r), EMPTY, IDEX(G2E, mov_r2cr), EMPTY,
  ...
  /* 0x90 */	IDEXW(setcc, setcc, 1), IDEXW(setcc, setcc, 1), IDEXW(setcc, setcc, 1), IDEXW(setcc, setcc, 1),
  /* 0x94 */	IDEXW(setcc, setcc, 1), IDEXW(setcc, setcc, 1), IDEXW(setcc, setcc, 1), IDEXW(setcc, setcc, 1),
  /* 0x98 */	IDEXW(setcc, setcc, 1), IDEXW(setcc, setcc, 1), IDEXW(setcc, setcc, 1), IDEXW(setcc, setcc, 1),
  /* 0x9c */	IDEXW(setcc, setcc, 1), IDEXW(setcc, setcc, 1), IDEXW(setcc, setcc, 1), IDEXW(setcc, setcc, 1),
